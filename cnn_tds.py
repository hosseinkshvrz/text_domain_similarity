...
from keras.layers import Embedding, MaxPooling1D, multiply, subtract, Lambda, concatenate, Dense, Conv1D, Reshape, Conv2D
...
conved_sequences1 = Conv1D(300, kernel_size=3, activation='relu', kernel_initializer='he_uniform')(embedded_sequences1)
conved_sequences2 = Conv1D(300, kernel_size=3, activation='relu', kernel_initializer='he_uniform')(embedded_sequences2)

x_pool = MaxPooling1D(pool_size=38)(conved_sequences1)
y_pool = MaxPooling1D(pool_size=38)(conved_sequences2)
...
filepath = path + 'cnn_weights.last.hdf5'
