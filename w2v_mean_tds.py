...
from keras.layers import Embedding, multiply, subtract, Lambda, concatenate, Dense, Reshape
...
mean1 = Lambda(lambda x: mean(x, axis=1, keepdims=True))(embedded_sequences1)
mean2 = Lambda(lambda x: mean(x, axis=1, keepdims=True))(embedded_sequences2)

mean1 = Reshape((1, 300,))(mean1)
mean2 = Reshape((1, 300,))(mean2)

x_mult_y = multiply([mean1, mean2])
x_minus_y = subtract([mean1, mean2])
...
filepath = path + 'mean_weights.last.hdf5'
